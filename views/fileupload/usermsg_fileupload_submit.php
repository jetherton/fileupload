<div class="report_row" >
	...
	<div id="divFileUpload">
		<div class="row link-row-file">
			<a href="#" class="add" style="float:right;" onClick="addFileField('divFileUpload','usermsg_fileUpload','fileUpload_id','file'); return false;">
				<?php echo Kohana::lang('fileupload.add');?>
			</a>
			<?php echo Kohana::lang('fileupload.description');?><input type="text" name="fileUpload_description_1" id="fileUpload_description_1" value="" class="fileuploaddescription" style="width:170px;"/>
			<?php echo Kohana::lang('fileupload.file');?><input type="file" name="usermsg_fileUpload_1" value=""  style="border:none;width:200px; float:none;"class="fileuploadinput text long" /> 			
