	...
	<ul>
		<?php
			foreach ($files as $file) 
			{
				...
				print "<a href=\"#\" style=\"border:none; float:none; background:none; text-decoration:underline;\" onmousedown=\"addFile('".$prefix."/".$file_name."','".$file->file_title."')\">Insert file into description</a>";
